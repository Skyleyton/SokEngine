...
/*
    ...
    Cmdline:
        sokol-shdc -i shaders/points_shader.glsl -o source/points_shader.odin -l glsl430 -f sokol_odin

    Overview:
    =========
    Shader program: 'points':
        Get shader desc: points_shader_desc(sg.query_backend())
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_points_in_position => 0
            ATTR_points_in_color => 1
    Bindings:
*/
ATTR_points_in_position :: 0
ATTR_points_in_color :: 1
...
points_shader_desc :: proc (backend: sg.Backend) -> sg.Shader_Desc {
    desc: sg.Shader_Desc
    desc.label = "points_shader"
